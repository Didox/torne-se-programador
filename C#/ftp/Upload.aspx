<%@ Page language="c#" Codebehind="Upload.aspx.cs" AutoEventWireup="false" Inherits="ftp.Upload" %>
...
<HTML>
	<HEAD>
		...
		{
			document.getElementById("Frame").src="newdir2.aspx?main="+main+"&dir="+caminho;
		...
		{		
			window.open( 'VerImagem2.aspx?path=' + caminho,null,"height=20px,width=250px,status=no,toolbar=no,menubar=no,location=no" )			
		}
		function EnviarArquivo(main,caminho)
		{
			...
			document.getElementById("Frame").src="Up2.aspx?main="+main+"&dir="+caminho;
			document.getElementById("env").style.display = "block";
			return false;
		}
	...
	<body leftMargin="0" topMargin="0" onload="" marginheight="0" marginwidth="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
					...
					<td colSpan="2" height="25">
						<TABLE height="25" cellSpacing="0" cellPadding="0" width="100%" background="imagens/FTP/topo.gif"
							...
							<TR>
								...
								<TD><asp:textbox id="txtDir" runat="server" ReadOnly="True" Width="99%" CssClass="campo_branco"></asp:textbox></TD>
							</TR>
						</TABLE>
					</td>
				</tr>
			...
			<table height="42" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					...
					<td vAlign="top" width="94%"><GRID:DATAGRID id="Grid" runat="server" Width="100%" CssClass="Font" background="imagens/FTP/fundo.gif"
							CellPadding="0" BorderColor="Beige" BorderWidth="1px" AutoGenerateColumns="False" EnableColumnDrag="True" SmartClientRendering="True"
							...
							<COLUMNS>
								...
								<ASP:BOUNDCOLUMN HeaderText="Tamanho" DataField="Tamanho">
								...
								<ASP:BOUNDCOLUMN HeaderText="NomeLimpo" DataField="NomeLimpo" Visible="false"></ASP:BOUNDCOLUMN>
							</COLUMNS>
						</GRID:DATAGRID></td>
				</tr>
				<tr>
