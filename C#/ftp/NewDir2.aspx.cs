namespace FTP
{
	...
	public class NewDir2 : Page
	{
		...
		private void btnEnviar_Click(object sender, EventArgs e)
		{
			...
			try
			{
				string str3 = AppDomain.CurrentDomain.BaseDirectory + ConfigurationSettings.AppSettings["dirMainImagesAdm"] + str2 + "/" + str;
				string oldValue = base.Request["main"].Trim().ToLower() + "/";
				(str2.ToLower().Replace(oldValue, "") + "/" + str).Trim();
				...
				this.Page.RegisterStartupScript("alert", "<script>window.parent.location='upload.aspx?dirUser=" + base.Request["main"].Trim() + "';window.close()</script>");
			}
