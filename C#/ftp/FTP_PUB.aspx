<%@ Page language="c#" Codebehind="FTP_PUB.aspx.cs" AutoEventWireup="false" Inherits="ftp.FTP_PUB" %>
...
<HTML>
	<HEAD>
		...
		function EnviarArquivo(caminho)
		{
			...
			document.getElementById("Frame").src="Up.aspx?dir="+caminho;
			document.getElementById("env").style.display = "block";
			return false;
		}
	...
	<body onload="" MS_POSITIONING="GridLayout" leftmargin="0" topmargin="0" marginwidth="0"
		...
		<form id="Form1" method="post" runat="server">
			<table height="40" cellSpacing="0" cellPadding="0" width="103%" border="0">
				<tr>
			...
			<asp:textbox id="txtDir" runat="server" CssClass="campo_branco" visible="false" Width="99%" ReadOnly="True"></asp:textbox>
			<table height="42" cellSpacing="0" cellPadding="0" width="103%" border="0">
				<tr>
					<!--td width="6%">
					...
					<td vAlign="top" width="94%"><GRID:DATAGRID id="Grid" runat="server" CssClass="Font" Width="100%" EnableClientSort="True" SmartClientRendering="True"
							EnableColumnDrag="True" AutoGenerateColumns="False" BorderWidth="1px" BorderColor="Beige" CellPadding="0" background="imagens/FTP/fundo.gif">
							...
							<COLUMNS>
								...
								<ASP:TEMPLATECOLUMN HeaderText="Nome" visible="false">									
