<%@ Page language="c#" Codebehind="NewDir.aspx.cs" AutoEventWireup="false" Inherits="FTP.NewDir" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Criar Diretório</title>
			...
			<TABLE cellSpacing="10" cellPadding="0" width="100%" border="0" class="Font" id="tblDoUp">
				<TR>
					<TD>Nome:&nbsp;<br>
						...
						<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ErrorMessage="O Nome do Diretório Obrigatório"
