...
namespace Business
{
	...
	public class BsItemField
	{
		...
		public void ExcludeObject()
		{
			...
			Database.DaItemFields.ExcludeObject( _id );
		}

		public void SaveObject() { Database.DaItemFields.SaveObject( ref _id, _field.Id, _value ); }

		public BsItemField GetObject()
		{	
			if( _id <= 0 ) return this;
			DataTable dt = Database.DaItemFields.GetItemFields( _id, _field.Id );	
			if( dt.Rows.Count > 0 )
