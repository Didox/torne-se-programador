namespace CSGen.GeraDataBaseClass
{
    ...
    internal class GerarDataBaseClass
    {
        ...
        private static string GerarCorpo(SqlTable sqlTable)
        {
            ...
            strArray[0] = "using System;\nusing System.Data;\nusing System.Data.SqlClient;\nusing System.Data.Common;\nusing System.Configuration;\n\nnamespace ";
            strArray[1] = Program.prefixNamespace;
            char ch = classDataBaseNome[0];
            strArray[3] = ch.ToString().ToUpper();
            strArray[4] = classDataBaseNome.Remove(0, 1);
            strArray[2] = "DataBase\n{\n\t #region Class " + strArray[3] + strArray[4] + "\n\t/// <summary>\n\t/// Classe de opera\x00e7\x00f5es de " + classDataBaseNome.ToLower() + " na base\n\t/// </summary>\n\t/// <remarks>Danilo Aparecido</remarks>\n\tpublic class ";
            ...
            char ch2 = classDataBaseNome[0];
            strArray[6] = ch2.ToString().ToUpper();
            strArray[7] = classDataBaseNome.Remove(0, 1);
            strArray[8] = "()\n\t\t{\n\t\t\ttry{ strConn = ConfigurationManager.ConnectionStrings[\"";
            strArray[9] = Program.webConfigConnection;
            strArray[10] = "\"].ConnectionString; }\n\t\t\tcatch(Exception ex){ throw ex; }\n\t\t}\n\t\t#endregion\n\t\n\t\t*metodos*\n\t}\n\t #endregion\n}";
        ...
        private static string GerarSelect(SqlTable sqlTable)
        {
            ...
            if (!sqlTable.IsTableNo)
            {
                ...
                builder.AppendLine("\t\t\t\treturn cmd.ExecuteReader();");
                builder.AppendLine("\t\t\t}");
                builder.AppendLine("\t\t\tcatch (SqlException sex){ throw sex; }");
                builder.AppendLine("\t\t\tcatch (Exception ex){ throw ex; }");
                builder.AppendLine("\t\t}");
        ...
        private static string GerarSolectNode2(SqlTable sqlTable)
        {
            ...
            strArray[0] = "\t\t\t\tcmd.CommandText = \"usp_";
            strArray[1] = Program.sulfixSelect;
            strArray[2] = table.ClassBusinessNome;
            strArray[3] = "By";
            char ch = table2.GetIdentityColumn().Name[0];
            strArray[4] = ch.ToString().ToUpper();
            strArray[5] = table2.GetIdentityColumn().Name.Substring(1);
            strArray[6] = "\";";
            ...
            strArray[0] = "\t\t\t\tcmd.CommandText = \"usp_";
            strArray[1] = Program.sulfixSelect;
            strArray[2] = table2.ClassBusinessNome;
            strArray[3] = "By";
            ch = table.GetIdentityColumn().Name[0];
            strArray[4] = ch.ToString().ToUpper();
            strArray[5] = table.GetIdentityColumn().Name.Substring(1);
            strArray[6] = "\";";
            builder.AppendLine(string.Concat(strArray));
