...
if request("flag") = 1 then
   ...
   if msg="" then
      conn.execute("insert into unidade(descricao,endereco,numero,complemento,bairro,cidade,estado,cep,ddd_fone,fone,data_inclusao) values ('"&descricao&"','"&logradouro&"','"&numero&"','"&compl&"','"&bairro&"','"&cidade&"','"&estado&"','"&cep&"','"&ddd&"','"&fone&"',convert(datetime ,'"&date()&"', 103))")%>
      <script>
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para cadastrar uma nova unidade siga os passos descrito abaixo.<br><br></b>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_3.gif">&nbsp;CADASTRAR NOVA UNIDADE
          </td>
