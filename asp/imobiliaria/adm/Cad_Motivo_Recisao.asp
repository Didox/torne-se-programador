...
if request("flag") = 1 then
   ...
   if descricao<>"" then
      set verifica_descricao=conn.execute("select * from TIPO_MOTIVO where descricao='"&descricao&"'")
   ...
   if msg="" then
      conn.execute("insert into tipo_motivo (descricao) values ('"&descricao&"')")%>
      <script>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_14.gif">&nbsp;CADASTRAR NOVO MOTIVO DE RECISÃO<br><br>
          </td>
