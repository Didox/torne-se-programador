...
if request("flag") = 1 then
   ...
   if msg="" then
      conn.execute("insert into procura_imovel (nome,ddd,fone,email) values ('"&nome&"','"&ddd&"','"&fone&"','"&email&"')")%>
      <script>
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para cadastrar nova procura de imovel siga os passos descrito abaixo.<br><br></b>
