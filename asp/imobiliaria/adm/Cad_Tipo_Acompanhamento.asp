...
if request("flag") = 1 then
   ...
   if descricao<>"" then
      set verifica_descricao=conn.execute("select * from tipo_Acompanhamento where descricao='"&descricao&"' and tempo='"&tempo&"'")
   ...
   if msg="" then
      conn.execute("insert into tipo_Acompanhamento (descricao, tempo) values ('"&descricao&"', '"&tempo&"')")%>
      <script>
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para cadastrar uma novo tipo de acompanhamento siga os passos descrito abaixo.<br><br></b>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_14.gif">&nbsp;CADASTRAR NOVO TIPO DE ACOMPANHAMENTO<br><br>
          </td>
        ...
        <tr>
          <td>
            <img src="../img/obrigacao.gif">&nbsp;<span class="estilo">Tempo(dias):
          </td>
        </tr>
        <tr>
          <td>
