...
if request("flag") <> 1 then
   ...
   if login2<>"" then
      set verifica_login=conn.execute("select * from clientes where login='"&login2&"' and status=0 and codigo<>"&codigo)
   ...
   if msg="" and reload="" then
      if tipo = "1" then
        conn.execute("update clientes set tipo="&tipo&",nome='"&nome&"',endereco='"&endereco&"',numero='"&numero&"',complemento='"&complemento&"',bairro='"&bairro&"',cidade='"&cidade&"',estado='"&estado&"',cep='"&cep&"',ddd_fone='"&ddd&"',fone='"&fone&"',ddd_cel='"&dddc&"',celular='"&celular&"',cpf='"&cpf&"',identidade='"&identidade&"',email='"&email&"',login='"&login2&"',senha='"&senha2&"',cod_banco="&banco&",agencia='"&agencia&"',conta='"&conta&"',renda="&replace(replace(csng(renda),".",""),",",".")&",data_inclusao=convert(datetime,'"&date()&"',103),cod_escolaridade="&escolaridade&", estado_civil="&estado_civil&", sexo="&sexo&", data_nascimento=convert(datetime,'"&data_nascimento&"',103), data_admissao=convert(datetime,'"&data_admissao&"',103), renda_extra="&replace(replace(csng(renda_extra),".",""),",",".")&", empresa='"&empresa&"', cartorio='"&cartorio&"', data_emissao=convert(datetime,'"&data_emissao&"',103), cargo='"&cargo&"', profissao='"&profissao&"', orgao_emissor='"&orgao_emissor&"', tipo_imovel="&tipo_imovel&" where codigo = "&codigo)
      else
        conn.execute("update clientes set tipo="&tipo&",nome='"&nome&"',endereco='"&endereco&"',numero='"&numero&"',complemento='"&complemento&"',bairro='"&bairro&"',cidade='"&cidade&"',estado='"&estado&"',cep='"&cep&"',ddd_fone='"&ddd&"',fone='"&fone&"',ddd_cel='"&dddc&"',celular='"&celular&"',cpf='"&cpf&"',email='"&email&"',login='"&login2&"',senha='"&senha2&"',cod_banco="&banco&",agencia='"&agencia&"',conta='"&conta&"',renda="&replace(replace(csng(renda),".",""),",",".")&",data_inclusao=convert(datetime,'"&date()&"',103),data_admissao=convert(datetime,'"&data_admissao&"',103), renda_extra="&replace(replace(csng(renda_extra),".",""),",",".")&", empresa='"&empresa&"', cartorio='"&cartorio&"', tipo_imovel="&tipo_imovel&" where codigo="&codigo)
      end if%>
      <script>
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para alterar um cliente siga os passos descrito abaixo.<br><br></b>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_8.gif">&nbsp;ALTERAR CLIENTE
          </td>
        ...
        <tr>
          <td>
            <table cellspacing=0 cellpadding=0>
              ...
              <tr>
                <td>
                  <input type="text" name="numero" value="<%=numero%>" maxlength=15 label="número" style="width:90; height:17; background=#E8E8E8;" onkeypress="Numero()">
                </td>
                <td>
                ...
                <td>
                  <select name="tipo_imovel" style="width:140;background=#E8E8E8;">
                    ...
                    <%do while not cbai.eof %>
                      <%if cbai("codigo")= tipo_imovel then%>
        ...
        <tr>
          <td>
            <table cellspacing=0 cellpadding=0>
              ...
              <tr>
                <td>
                  <input type="text" name="ddd" value="<%=ddd%>"  maxlength=3 label="ddd" style="width:26; height:17; background=#E8E8E8;">&nbsp;<input type="text" name="fone" value="<%=fone%>" maxlength=30 label="fone" style="width:86; height:17; background=#E8E8E8;">
                </td>
                <td>
                  <input type="text" name="dddc" value="<%=dddc%>"  maxlength=3 label="ddd_cel" style="width:26; height:17; background=#E8E8E8;">&nbsp;<input type="text" name="celular" value="<%=celular%>" maxlength=30 label="celular" style="width:86; height:17; background=#E8E8E8;">
                </td>
              </tr>
            </table>
          </td>
            ...
            <table cellspacing=0 cellpadding=0>
              ...
              <tr>
	            ...
	            <%do while not bancos.eof %>
	              <%if cstr(bancos("codigo"))=cstr(banco) then%>
        ...
        <tr>
          <td>
            <table cellspacing=0 cellpadding=0 border=0>
              ...
              <tr>
                <td>
                  <input type="text" name="renda" value="<%=renda%>" label="renda" style="width:60;height:17;background:#E8E8E8;text-align: RIGHT;" maxlength="18" onkeypress="Numero();" onkeyup="Moeda(this);">
                </td>
                <td>
                  <input type="text" name="renda_extra" value="<%=renda_extra%>" label="renda_extra" style="width:60;height:17;background:#E8E8E8;text-align: RIGHT;" maxlength="18" onkeypress="Numero();" onkeyup="Moeda(this);">
                </td>
              </tr>
              <tr>
                <td>
        ...
        <tr>
               ...
               <tr>
                <td>
                  <select name="bem" style="width:140;background=#E8E8E8;">
                    ...
                    <%do while not cbai.eof %>
                      <%if cstr(cbai("codigo"))=cstr(tipo_bens) then%>
                         <option value="<%=cbai("codigo")%>" selected><%=cbai("descricao")%>
                      <%else%>
                         <option value="<%=cbai("codigo")%>"><%=cbai("descricao")%>
                      <%end if%>
                ...
                <td>
                  <input type="text" name="valor" value="" label="valor" style="width:60; height:17; background=#E8E8E8;"> 
                </td>
                <td>
                </td>
                <td align=center>
                  <input type="image" src="../img/ok.gif" value="enviar" border=0 onclick="document.form1.reload.value='1'">
                </td>
              </tr>
            </table>
	      ...
	      <tr>
                <td>
                  <input type="password" name="senha2" value="<%=senha2%>" maxlength=20 label="senha" style="width:126; height:17; background=#E8E8E8;">&nbsp;<a HREF="javascript:chamar_senha()"><span span class="estilo"> <img src="../img/helpicon.gif" border=0></a>
                </td>
                <td>
                  &nbsp;&nbsp;<input type="password" name="senha3" value="<%=senha3%>" maxlength=20 label="senha" style="width:126; height:17; background=#E8E8E8;">&nbsp;<a HREF="javascript:chamar_senha()"><span span class="estilo"> <img src="../img/helpicon.gif" border=0></a>
                </td>
              </tr>
              </tr>
            </table>
