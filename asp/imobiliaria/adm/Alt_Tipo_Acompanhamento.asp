...
if request("flag") <> 1 then
   set Acompanhamento=conn.execute("select * from tipo_Acompanhamento where codigo="&codigo)
   descricao=replace(trim(ucase(Acompanhamento("descricao"))),"'","")
   tempo=trim(ucase(Acompanhamento("tempo")))
else
   descricao=trim(ucase(request("descricao")))
   tempo=trim(ucase(request("tempo")))
   if descricao<>"" then
      set verifica_descricao=conn.execute("select * from tipo_Acompanhamento where descricao='"&descricao&"'  and tempo="&tempo&" and codigo<>"&codigo)
   ...
   if msg="" then
      conn.execute("update tipo_Acompanhamento set descricao='"&descricao&"', tempo="&tempo&" where codigo="&codigo)%>
      <script>
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para alterar tipo de acompanhamento siga os passos descrito abaixo.<br><br></b>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            ...
            <img src="../img/<%=image%>">&nbsp;ALTERAR TIPO DE ACOMPANHAMENTO<br><br>
          </td>
        ...
        <tr>
          <td>
            <input type="text" name="descricao" value="<%=descricao%>" maxlength=50 label="Serviço" style="width:290; height:17; background=#E8E8E8;">
          </td>
        </tr>
        <tr>
        <tr>
          <td>
            <img src="../img/obrigacao.gif">&nbsp;<span class="estilo">Tempo:
          </td>
        </tr>
        <tr>
          <td>
            <input type="text" name="tempo" value="<%=tempo%>" maxlength=3 label="tempo" style="width:50; height:17; background=#E8E8E8;">
          </td>
        </tr>
        <tr>
          <td align=center>
