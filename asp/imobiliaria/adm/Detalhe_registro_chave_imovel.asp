    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            ...
            &nbsp;&nbsp;<img src="../img/b_bullet.gif">&nbsp;A chave deve está na imobiliaria.<br>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_14.gif">&nbsp;DETALHE AUSÊNCIA DE CHAVE<br><br>
          </td>
        ...
        <tr>
         ...
         <tr>
           <td>
	         ...
	         <tr>
	          <td>
	            <span class="estilo">Data de saída:
	          </td>
	          <td>
	 ...
	 <tr>
           <td>
	         ...
	         <tr>
	          <td>
	            <span class="estilo">Hora de saída:
	          </td>
	          <td>
