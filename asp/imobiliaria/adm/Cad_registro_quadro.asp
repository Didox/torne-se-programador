...
if request("flag") = 1 then
   ...
   if quantidade<>"" then
      ...
      if cint(quadro("quadro"))>cint(registro("quadro")) then
         msg = msg&" Existe registro disponível.<br>quantidade de registros "&cint(quadro("quadro"))-cint(registro("quadro"))&".<br>"
      end if
   else
  ...
  <tr>
    <td>
      ...
      <table border="0" width=376 align=right>
        ...
        <tr>
          <td>
            <img src="../img/obrigacao.gif">&nbsp;<span class="estilo">Quantidade de posições no quadro:
          </td>
        </tr>
        <tr>
          <td>
