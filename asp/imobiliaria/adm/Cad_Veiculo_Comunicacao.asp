...
if request("flag") = 1 then
   ...
   if descricao<>"" then
      ...
      if not verifica_descricao.eof then
         msg=msg&" Veículo de Comunicação já existe<br>"
      end if
   else
      msg=msg&" Veículo de Comunicação.<br>"
   end if
   if msg="" then
      conn.execute("insert into veiculo_comunicacao (descricao, cod_Unidade_metrica, data_inclusao) values ('"&descricao&"', "&unidade&", convert(datetime,'"&date()&"',103))")%>
      <script>
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para cadastrar uma novo veículo de comunicação siga os passos descrito abaixo.<br><br></b>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_14.gif">&nbsp;CADASTRAR NOVO VEÍCULO DE COMUNICAÇÃO<br><br>
          </td>
