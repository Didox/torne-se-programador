         ...
         <tr>
          <td>
            <select name="subtipo_imovel" style="width:140;background=#E8E8E8;">
              <option value = ""></option>
              <option value = "Apartamento" <%if UCase(trim(subtipo_imovel)) = trim("APARTAMENTO") then%>selected<%end if%>>Apartamento</option>
              <option value = "Casa" <%if UCase(trim(subtipo_imovel)) = trim("CASA") then%>selected<%end if%>>Casa</option>
              <option value = "Flat" <%if UCase(trim(subtipo_imovel)) = trim("FLAT") then%>selected<%end if%>>Flat</option>
              <option value = "Loteamento" <%if UCase(trim(subtipo_imovel)) = trim("LOTEAMENTO") then%>selected<%end if%>>Loteamento</option>
              <option value = "Sobrado" <%if UCase(trim(subtipo_imovel)) = trim("SOBRADO") then%>selected<%end if%>>Sobrado</option>
            </select>
          </td>
         </tr>
      </table>
