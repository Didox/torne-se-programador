...
if request("flag") = 1 then
   ...
   if descricao<>"" and supervior <> "" then
      set verifica_descricao=conn.execute("select * from equipe where descricao='"&descricao&"' and cod_supervisor = "&supervisor)
   ...
   if msg="" then
      conn.execute("insert into equipe (descricao, cod_supervisor) values ('"&descricao&"', "&supervisor&")")%>
      <script>
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para cadastrar uma nova equipe siga os passos descrito abaixo.<br><br></b>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_14.gif">&nbsp;CADASTRAR NOVO EQUIPE<br><br>
          </td>
        ...
        <tr>
          <td>
            <select name="supervisor" style="background=#E8E8E8;width:290">
              <option value = ""></option>
              ...
              <%do while not cbai.eof %>
                ...
                <%end if%>
                <%if cstr(cbai("codigo"))= supervisor then%>
