...
if request("flag") = 1 then
   ...
   if descricao<>"" then
      set verifica_descricao=conn.execute("select * from Tipo_imovel where descricao='"&descricao&"'")
      if not verifica_descricao.eof then
         msg=msg&" Tipo de imóvel já existe<br>"
      end if
   else
      msg=msg&" Tipo de imóvel.<br>"
   end if
   if msg="" then
      conn.execute("insert into Tipo_imovel (descricao) values ('"&descricao&"')")%>
      <script>
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para cadastrar uma novo tipo de imovel siga os passos descrito abaixo.<br><br></b>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_14.gif">&nbsp;CADASTRAR NOVO TIPO DE IMOVEL<br><br>
          </td>
