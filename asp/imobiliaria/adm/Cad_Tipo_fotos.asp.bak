...
if request("flag") = 1 then
   ...
   if descricao<>"" then
      set verifica_descricao=conn.execute("select * from tipo_comodo where descricao='"&descricao&"'")
   ...
   if msg="" then
      conn.execute("insert into tipo_comodo (descricao) values ('"&descricao&"')")%>
      <script>
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para cadastrar uma novo tipo de comodo siga os passos descrito abaixo.<br><br></b>
