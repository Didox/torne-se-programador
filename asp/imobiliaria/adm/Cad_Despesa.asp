          ...
          <td>
            <table cellspacing=0 cellpadding=0>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="valor_despesa" value="" label="valor" style="width:60; height:17;background:#E8E8E8;text-align: RIGHT;" maxlength="18" onkeypress="Numero();" onkeyup="Moeda(this);">&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
                <td align=center>
