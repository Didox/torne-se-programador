...
if request("flag") = 1 then
   ...
   sqlupd = "Update lazer Set descricao = '"&descricao&"' Where codigo = "&request("codigo")&""
   conn.execute(sqlupd)%>
   <script>
     alert('Lazer editado com sucesso!');
     location.href="<%=pagina%>.asp";
   </script>
 <%
end if

Set lazer = conn.execute("Select * from lazer where codigo = "&request("codigo")&"")
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para editar uma área de lazer siga os passos descrito abaixo.<br><br></b>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_14.gif">&nbsp;EDITAR ÁREA DE LAZER<br><br>
          </td>
