...
if request("flag") = 1 then
   ...
   if descricao<>"" then
      set verifica_descricao=conn.execute("select * from tipo_moeda where descricao='"&descricao&"'")
   ...
   if msg="" then
      conn.execute("insert into tipo_moeda (descricao, sigla, data_inclusao) values ('"&descricao&"','"&sigla&"', convert(datetime,'"&date()&"',103))")%>
      <script>
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para cadastrar um novo tipo de moeda siga os passos descrito abaixo.<br><br></b>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_14.gif">&nbsp;CADASTRAR NOVO TIPO DE MOEDA<br><br>
          </td>
        ...
        <tr>
          <td>
            <img src="../img/obrigacao.gif">&nbsp;<span class="estilo">Sigla:
          </td>
        </tr>
        <tr>
          <td>
            <input type="text" name="sigla" value="<%=sigla%>" maxlength=2 label="sigla" style="width:30; height:17; background=#E8E8E8;">
          </td>
        </tr>
        <tr>
          <td align=center>
