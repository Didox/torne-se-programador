...
if request("flag") = 1 then
   ...
   if valida_indice.eof then
      if msg="" then
         conn.execute("insert into indice(descricao,valor,data_atualizada) values ('"&descricao&"',"&replace(replace(csng(valor),".",""),",",".")&",convert(datetime,'"&date()&"',103))")%>
         <script>
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para cadastrar um novo índice siga os passos descrito abaixo.<br><br></b>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_14.gif">&nbsp;CADASTRAR NOVO ÍNDICE
          </td>
        ...
        <tr>
          <td>
            <input type="text" name="valor" value="<%=valor%>" label="cpf" style="width:60; height:17;background:#E8E8E8;text-align: RIGHT;" maxlength="18" onkeypress="Numero();" onkeyup="Moeda(this);">
          </td>
        </tr>
        <tr>
          <td>
