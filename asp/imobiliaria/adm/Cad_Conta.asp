...
if request("flag") = 1 then
   ...
   if msg="" then
     conn.execute("insert into Contas (tipo,cod_tipo_conta,cod_setor,data,numero,valor,descricao) values ("&tipo&",'"&tipo_conta&"','"&setor&"',convert(datetime,'"&data&"',103),'"&numero&"',"&replace(replace(csng(valor),".",""),",",".")&",'"&descricao&"')")%>
      <script>
        ...
        <tr>
          <td>
            <table cellspacing=0 cellpadding=0>
              ...
              <tr>
                <td>
                  <input type="text" name="valor" value="<%=valor%>"  label="valor" style="width:126; height:17;background:#E8E8E8;text-align: RIGHT;" maxlength="18" onkeypress="Numero();" onkeyup="Moeda(this);">&nbsp;<a HREF="javascript:chamar_senha()"><span span class="estilo"></a>
                </td>
              </tr>
            </table>
          </td>
