                  ...
                  <tr>
                    ...
                    <td bgcolor=<%=cor%> align=center>
                      ...
                      <%if comissao.eof then%>
                        <a href="Cad_comissao.asp?codigo=<%=itens("codigo")%>&codigo2=<%=codigo%>&pagina=Detalhe_cliente"><img src="../img/comissao.gif" alt="Comissão" border=0></a>
                      <%else%>
                        <a href="Alt_comissao.asp?codigo=<%=itens("codigo")%>&codigo2=<%=codigo%>&pagina=Detalhe_cliente"><img src="../img/comissao.gif" alt="Comissão" border=0></a>
                      <%end if%>
                    </td>
                  </tr>
                  <%cont=cont+1%>
