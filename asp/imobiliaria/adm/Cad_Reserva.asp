...
if request("flag") = 1 then
   ...
   validade=replace(trim(ucase(request("validade"))),"'","")
   ...
   if msg="" then
      conn.execute("insert into reserva(nome , cod_imovel , cod_corretor ,data , validade , ddd , fone) values ('"&nome&"',"&imovel&","&corretor&",convert(datetime,'"&data&"',103),convert(datetime,'"&validade&"',103),'"&ddd&"','"&fone&"')")%>
      <script>
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para cadastrar uma nova reserva siga os passos descrito abaixo.<br><br></b>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_14.gif">&nbsp;CADASTRAR RESERVA
          </td>
          ...
          <td>
            <table cellspacing=0 cellpadding=0>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="validade" value="<%=validade%>" maxlength=10 label="validade" style="width:86; height:17; background=#E8E8E8;" onkeypress="Numero();DATA(this);">
                </td>
              </td>
            </table>
          </td>
