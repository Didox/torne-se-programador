...
if request("flag") <> 1 then
   set Funcionario=conn.execute("select * from Funcionario where codigo="&codigo)
   ...
   cep        =Funcionario("cep")
   ddd_fone   =Funcionario("ddd_fone")
   fone       =Funcionario("fone")
   ddd_cel    =Funcionario("ddd_cel")
   celular    =Funcionario("celular")
   email      =Funcionario("email")
   unidade    =Funcionario("cod_unidade")
   funcao     =Funcionario("cod_funcao")
   setor      =Funcionario("cod_setor")
   escolaridade   = Funcionario("cod_escolaridade")
   estado_civil   =Funcionario("estado_civil")
   sexo           =Funcionario("sexo")
   data_nascimento=data_completa(Funcionario("data_nascimento"))
   data_emissao   =data_completa(funcionario("data_emissao"))
   ...
   if cpf<>"" then
      ...
      set verifica_cpf=conn.execute("select * from Funcionario where cpf='"&cpf&"' and codigo<>"&codigo)
   ...
   if msg="" then
      cpf=replace(cpf,".","")
      cpf=replace(cpf,"-","")
      conn.execute ("update Funcionario set nome = '"&nome&"', endereco = '"&logradouro&"', numero = '"&numero&"', complemento = '"&complemento&"', bairro = '"&bairro&"', cidade = '"&cidade&"', estado = '"&estado&"', cep = '"&cep&"', ddd_fone = "&ddd_fone&", fone = '"&fone&"', ddd_cel = '"&ddd_cel&"', celular = '"&celular&"', cpf = '"&cpf&"', identidade = '"&identidade&"', email = '"&email&"', cod_unidade = "&unidade&" , cod_funcao = "&funcao&" , cod_setor = "&setor&", cod_escolaridade="&escolaridade&", sexo="&sexo&", estado_civil="&estado_civil&", orgao_emissor='"&orgao_emissor&"', data_emissao=convert(datetime,'"&data_emissao&"',103), data_nascimento=convert(datetime,'"&data_nascimento&"',103) where codigo = "&codigo)%>
      <script>
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para alterar funcionário siga os passos descrito abaixo.<br><br></b>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_10.gif">&nbsp;ALTERAR FUNCIONÁRIO
          </td>
          ...
          <td>
            <table cellspacing=0 cellpadding=0 border=0>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="data_emissao" value="<%=data_emissao%>" maxlength=15 label="data_emissao" style="width:100; height:17; background=#E8E8E8;" onkeyup="Numero(this.value,this);DATA(this.value,this);">
                </td>
              </tr>
              <tr>
                <td colspan=5>
              ...
              <tr>
                <td colspan=5>
                  <input type="text" name="cpf" value="<%=cpf%>"  maxlength=14 label="cpf" style="width:145; height:17; background=#E8E8E8;" onkeyup="Numero(this.value,this)">
                </td>
              </tr>
            </table>
        ...
        <tr>
          <td>
            <table cellspacing=0 cellpadding=0>
              ...
              <tr>
                <td>
                  <input type="text" name="numero" value="<%=numero%>" maxlength=10 label="número" style="width:90; height:17; background=#E8E8E8;" onkeyup="Numero(this.value,this)">
                </td>
                <td>
          ...
          <td>
            <table cellspacing=0 cellpadding=0>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="cep" value="<%=cep%>" maxlength=10 onkeyup="Numero(this.value,this);CEP(this.value,this);" maxlength=14 label="cpf" style="width:80; height:17; background=#E8E8E8;">&nbsp;&nbsp;<a HREF="javascript:chamar_cep()"><span span class="estilo"> <img src="../img/correios.gif" alt="Consultar correios" border=0></a>
                </td>
              </tr>
              </tr>
                <td>
              ...
              <tr>
                <td>
                  <input type="text" name="data_nascimento" value="<%=data_nascimento%>" maxlength=30 label="Cidade" style="width:100; height:17; background=#E8E8E8;" onkeyup="Numero(this.value,this);DATA(this.value,this);">
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td>
            <table cellspacing=0 cellpadding=0>
              ...
              <tr>
                <td>
                  <input type="text" name="ddd_fone" value="<%=ddd_fone%>"  maxlength=2 onkeyup="Numero(this.value,this);" label="ddd" style="width:26; height:17; background=#E8E8E8;">&nbsp;<input type="text" name="fone" value="<%=fone%>" maxlength=13 label="fone" style="width:86; height:17; background=#E8E8E8;">
                </td>
                <td>
                  <input type="text" name="ddd_cel" value="<%=ddd_cel%>"  maxlength=2 label="ddd" onkeyup="Numero(this.value,this);" style="width:26; height:17; background=#E8E8E8;">&nbsp;<input type="text" name="celular" value="<%=celular%>" maxlength=13 label="celular" style="width:86; height:17; background=#E8E8E8;">
                </td>
              </tr>
            </table>
          </td>
