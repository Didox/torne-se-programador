               ...
               do While Not itens.EOF and cont<itens.PageSize
                  ...
                  <tr>
                    ...
                    <%else%>
                      ...
                      <%loop%>
                      <%if devendo=1 then%>
                         <a href="Main_contrato_pagamento.asp?codigo=<%=itens("codigo")%>&pagina=Main_contrato"><img src="../img/honorarioon.gif" alt="Pagamento do Contrato" border=0></a>
                      <%else%>
                         <a href="Main_contrato_pagamento.asp?codigo=<%=itens("codigo")%>&pagina=Main_contrato"><img src="../img/honorarioof.gif" alt="Pagamento do Contrato" border=0></a>
                      <%end if%>
                      <%devendo=0%>  
                      <%end if
                    end if%>
