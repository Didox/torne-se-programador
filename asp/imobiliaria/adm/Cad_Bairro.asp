...
if request("flag") = 1 then
   ...
   if descricao<>"" then
      set verifica_descricao=conn.execute("select * from bairro where descricao='"&descricao&"' and cod_cidade="&cidade)
   ...
   if msg="" then
      conn.execute("insert into bairro (descricao , cod_cidade) values ('"&descricao&"' , "&cidade&")")%>
      <script>
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para cadastrar um novo estágio siga os passos descrito abaixo.<br><br></b>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_14.gif">&nbsp;CADASTRAR NOVO BAIRRO<br><br>
          </td>
          ...
          <td>
            <select name="cidade" style="width:140;background=#E8E8E8;">
             ...
             <%do while not ccid.eof %>
              <%if cstr(ccid("codigo"))=cidade then%>
