    ...
    <td>
      <!--#INCLUDE FILE ="Main_Topo.asp"-->
          ...
          <table width=100% border=0 cellspacing="0" cellpadding="0">
            <tr>
              <td class="tb" width=80><b>SETOR:</b></td>
              <td class="tb"><%=itens("setor")%></td>
            <tr>
            <tr>
              <td class="tb" width=80><b>FUNCIONÁRIO: </b></td>
              <td class="tb"><%=itens("funcionario")%></td>
            </tr>
            <tr>
              <td class="tb" width=150><b>DATA DE PAGAMENTO:</b></td>
              <td class="tb"><%=itens("data")%></td>
            </tr>
            <tr>
              <td class="tb" width=150><b>NUMERO DO DOCUMENTO:</b></td>
              <td class="tb"><%=itens("numero")%></td>
            </tr>
            <tr>
              <td class="tb" width=150><b>TIPO DA CONTA:</b></td>
              <td class="tb">
                 <%set tipo_conta = conn.execute("select * from tipo_conta where codigo="&itens("cod_tipo_conta"))%>
                 <%=tipo_conta("descricao")%>
              </td>
            </tr>
            <tr>
              <td class="tb" width=80><b>VALOR:</b></td>
