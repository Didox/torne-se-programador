...
<table border="0" width="777" cellspacing="0" cellpadding="0">
      <!--#INCLUDE FILE ="Main_Topo.asp"-->
          ...
          <%set exibir=conn.execute("select * from propostas where codigo="&codigo)%>
          ...
          <table width=100% border=0 bgcolor=#E8E8E8 cellspacing="0" cellpadding="0">
            <tr> 
              ...
              <td class="tb" align=right><a href="Imprimir_detalhe_proposta.asp?codigo=<%=exibir("codigo")%>&pagina=Detalhe_Proposta"><img src="../img/icone-imprimir.gif" border=0></a></td>
            </tr>
          </table>
