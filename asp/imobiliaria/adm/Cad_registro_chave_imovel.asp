...
if request("flag") = 1 then
   ...
   if imovel<>"" and data_saida<>"" and data_entrada<>"" then
      ...
      if not verifica_descricao.eof then
         msg=msg&" Ausência de Chave já cadastrada nestas datas.<br>"
      end if      
   end if
   if msg <> " Ausência de Chave já cadastrada.<br>" then   
   if corretor="0" then
     msg = msg&" Corretor.<br>"
   end if
       
   if not data_valida(data_saida,0) then   
      msg=msg&" Data de Saída.<br>"
   end if
   if not data_valida(data_entrada,0) then   
      msg=msg&" Data de Chegada.<br>"
   end if
   if hora_saida="" or len(hora_saida)<5 then   
      msg = msg&" Hora de saída.<br>"
   end if
   ...
   if msg="" then
      if datevalue(data_saida)>datevalue(data_entrada) then
        msg = msg&" Data de saída maior que data de chegada.<br>"
      end if  
   end if
   end if
   if msg="" then
    ...
    <td>
      ...
      <table border="0" align=left width=380 cellspacing="0" cellpadding="0">
        <tr>
          <td>
            <br>
            <span span class="estilo">&nbsp;&nbsp;<b>Para cadastrar um nova ausência chave siga os passos descrito abaixo.<br><br></b>
      ...
      <table border="0" width=376 align=right>
        <tr>
          <td span class="estilo" width=100%>
            <img src="../img/r_14.gif">&nbsp;CADASTRAR NOVA AUSÊNCIA DE CHAVE<br><br>
          </td>
        ...
        <tr>
          <td>
            <span class="estilo">Posição no quadro de chaves:&nbsp;<b><%=quadro%></b>
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
         ...
         <tr>
           <td>
	         ...
	         <tr>
	          <td>
	            <img src="../img/obrigacao.gif">&nbsp;<span class="estilo">Data de saída:
	          </td>
	          <td>
	 ...
	 <tr>
           <td>
	         ...
	         <tr>
	          <td>
	            <img src="../img/obrigacao.gif">&nbsp;<span class="estilo">Hora de saída:
	          </td>
	          <td>
