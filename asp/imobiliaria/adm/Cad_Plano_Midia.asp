...
if request("flag") = 1 then
   ...
   if descricao<>"" then
      set verifica_descricao=conn.execute("select * from planos where titulo='"&titulo&"'")
   ...
   if msg="" then
      sqlins = "insert into planos (titulo,Data_Inclusao,descricao,Validade,Valor,imagem) values ('"&titulo&"',convert(datetime,'"&date()&"',103),'"&descricao&"',"&Validade&","&Valor&",'"&imagem&"')"
