...
itens.Open "select * from forma_pagamento where status=0 "&sql&" order by descricao "&ordem2,conn%>
<html>
<head>
<title></title>
  ...
  <tr>
    <td class="navdroplist">
      ...
      <table width=100% align="center" bgcolor="#f7f7f7" border=0>
        <tr>
          <td class="navdroplist" align=center><B>RELATÓRIO FORMA(S) DE PAGAMENTO</B></td>
        </tR>
      </table>
      <br>
