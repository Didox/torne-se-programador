...
itens.Open "select * from indice where status=0 "&sql&" order by descricao "&ordem2,conn%>
<html>
<head>
<title></title>
  ...
  <tr>
    <td class="navdroplist">
      ...
      <table width=100% align="center" bgcolor="#f7f7f7" border=0>
        <tr>
          <td class="navdroplist" align=center><B>RELATÓRIO ÍNDICE(S)</B></td>
        </tR>
      </table>
      <br>
      ...
      <table width=100% align="center" bgcolor="#FFFFFF" border=0>
       ...
       <tr>
         ...
         <td class="navdroplist"><%=itens("data_atualizada")%></td>
       </tr>
      <%itens.MoveNext
       loop%>
    <tr>
