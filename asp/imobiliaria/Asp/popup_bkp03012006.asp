...
<table width="610"  border="0" align="center" cellpadding="2" cellspacing="0">
      ...
      <tr>
        ...
        <td valign="top"><table width="100%" height="290"  border="0" cellpadding="2" cellspacing="2">
          <tr>
            ...
            <%if imovel("tipo_imovel") <> "" then
                ...
                <tr>
                  ...
                  <td width="86" align="right"><a href="javascript:history.back()"><img src="../../imagens/botoes/fechar.gif" width="86" height="26" border="0"></a></td>
                </tr>
              </table></td>
          </tr>
          <tr bgcolor="D9D3AF">
          ...
          <tr bgcolor="D9D3AF">
            ...
            <td class="texto"><table width="200"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="156" height="17">Dormit&oacute;rios:</td>
                <td width="44"><%=imovel("Dormitorio")%></td>
              </tr>
              <tr>
  ...
  sqlpic = "Select DISTINCT tipo_fotos.* from tipo_fotos INNER JOIN registro_foto ON registro_foto.cod_comodo = tipo_fotos.codigo where registro_foto.cod_imovel = "&codigo2
    ...
    <table width="600"  border="0" cellspacing="0" cellpadding="0">
      <tr>
           <script language="javascript">
            ...
            count=0
            var content<%=fotos("codigo")%>=new Array()
        <%count=0%>
          <%do while not pic.eof %>
  	         content<%=fotos("codigo")%>[<%=count%>] = "<table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td>" +
		              "<img src='../../imagens/fotos/<%=pic("arquivo")%>'><br><br>" +
                              "<font class='estilo'><%=pic("reg_descricao")%></font><br><br>" + 
                              "</td></tr></table>";
               	document.write("<td class='estilo'> <table border=0 class='estilo' cellspacing='0' cellpadding='0' height='80'> <tr> <td><a href='javascript:changetext(content<%=fotos("codigo")%>[<%=count%>]);linkImagem();'><img src='../../imagens/fotos/<%=pic("arquivo")%>' width='76' height='76' border='0'></a></td> </tr> <tr> <td class='estilo'><%=pic("reg_descricao")%></td> </tr> </table> </td>")
          <%count=count+1
          pic.movenext
          loop%>
         </script>
...
<table width="610" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr> 
    <td align="center"> 
      <table width="610" height="80" align="center" cellpadding="0" cellspacing="0" class="estilo">
        <tr> 
