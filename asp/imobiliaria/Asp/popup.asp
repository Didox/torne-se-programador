...
<script language="javascript">
  function pop_preco(url)
  {
   ...
   function pop_anuncie(url)
  {
    window.open(url,"pop_anunciante","resizable=yes,scrollbars=no,location=no,top=0,left=100,width=294,height=271");
  }
  function linkImagem() {
    ...
    <td><table width="100%"  border="0" cellspacing="1" cellpadding="1">
      <tr>
        ...
        <%
				...
				Set rsIMG2 = conn.execute("Select * from registro_foto where cod_imovel ="&codigo2)
				if not rsIMG2.eof then
		%>
		<img src="../../imagens/fotos/<%=rsIMG2("arquivo")%>" width="162" height="290">
        		<%else%>
	    ...
	    <td valign="top"><table width="100%" height="290"  border="0" cellpadding="2" cellspacing="2">
          <tr>
            ...
            <%if imovel("tipo_imovel") <> "" then
                ...
                <tr>
				  ...
				  <%
				    If request("codigo")<>"" or request("codigo2")<>"" or request("pagina")<>"" then
				  %>
				  <a href="javascript:history.go(-1)">
				  <img src="../../imagens/voltar1.gif" width="86" height="26" border="0">
				  </a>
				  <%Else%>
          ...
          <tr bgcolor="D9D3AF">
            ...
            <td class="texto"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              ...
              <%end if%>
			  As informações na área de detalhes do imóvel são de responsabilidade exclusiva do anunciante.<br><br>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr align="center">
				...
				<td width="50%">
				<a href="javascript:pop_anuncie('detalhe_anunciante.asp?codigo=<%=session("cod")%>&codigo2=<%=codigo%>&imovel=<%=codigo2%>&cod_cli=<%=imovel("cod_cliente")%>')"><img src="../../imagens/botoes/dados-anunciante.gif" border=0>
				</td>
              </tr>
            </table></td>
            </tr>
