    ...
    <form method=post action="Main_fotos.asp?flag=1&pagina=<%=pagina%>&codigo=<%=codigo%><%if str = "cad" then%>&str=cad<%end if%>" name="form1" ENCTYPE="multipart/form-data">
       <table width="99%"  border="0" cellpadding="0" cellspacing="0">
          ...
          <td><table width=99% border=0 align="center" cellpadding="0" cellspacing="0" class="tabela002">
            ...
            <tr> 
              ...
              <td class="tb"><B>ADICIONAR FOTOS NO IMÓVEL</B>&nbsp;</td>
            </tr>
          </table>  </td>
		  </tr></table>
	  <table border="0" cellpadding=5 cellspacing=0>
       <tr>
        ...
        <tr>
          <td>
            <select name="comodo1" style="width:140;">
          ...
          <input type="file" name="imagem1" size=22  style="width:290; height:17; "></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
            ...
            <table width=100% cellspacing=0 cellpadding=0 border=0 >
              <tr>
                <td class="tabela002" width=100% height="19">
                 <font color="#333333">Descrição</font>
                </td>
                <td class="tabela002" >
                  <font color="#333333">Ações</font>
                </td>
              </tr>
