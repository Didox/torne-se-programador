...
contrato.open "select * from contrato where data_vencimento < convert(datetime ,'"&date()&"', 103) and status=0",conn%>
<html>
<head>
<title></title>
  ...
  <tr>
    <td class="navdroplist">
      ...
      <table width=100% align="center" bgcolor="#f7f7f7" border=0>
        <tr>
          <td class="navdroplist" align=center><B>RELATÓRIO CONTRATOS VENCIDOS</B></td>
        </tR>
      </table>
      <br>
      ...
      <hr>
           <table width=100% border=0 cellspacing="0" cellpadding="0">
            ...
            <table width=250 cellspacing=0 cellpadding=0 border=1 bordercolor="#F8F8F8">
              <tr>
                <td bgcolor=#AAAAAA width=100% class="navdroplist">
                  <font color="#FFFFFF">Serviço</font>
                </td>
                <td bgcolor=#AAAAAA align=center class="navdroplist">
                  <font color="#FFFFFF">Valor</font>
                </td>
              </tr>
            ...
            <table width=250 cellspacing=0 cellpadding=0 border=1 bordercolor="#F8F8F8">
              <tr>
                <td bgcolor=#AAAAAA class="navdroplist" width=100%>
                  <font color="#FFFFFF">Comodo</font>
                </td>
                <td bgcolor=#AAAAAA class="navdroplist" align=center>
                  <font color="#FFFFFF">Quantidade</font>
                </td>
              </tr>
