    ...
    <td>
      ...
      <table width=100% align="center" bgcolor="#FFFFFF" border=0>
        ...
        <table width=100% border=0 cellspacing="0" cellpadding="0">
            <tr>
              <td class="tb" width=60 ><b>NUMERO:</b></td>
              <td class="tb" ><%=exibir("numero")%></td>
              <tr height=5><td></td></tr>
            </tr>
            <tr>
              <td class="tb" width=60><b>CLIENTE:</b></td>
              <td class="tb" colspan=3><%=cliente("nome")%></td>
              <tr height=2><td></td></tr>
            </tr>
            <tr>
              <td class="tb" width=70><b>IMÓVEL:</b></td>
              <td class="tb" colspan=3><%=imovel("descricao")%></td>
              <tr height=2><td></td></tr>              
            </tr>
            <tr>
              <td class="tb" width=70><b>FIADOR 1:</b></td>
            ...
            <tr>
              <td class="tb" width=70><b>FIADOR 2:</b></td>
              <td class="tb" colspan=3><%=fiador2("nome")%></td>
              <tr height=2><td></td></tr>              
            </tr>
            <% end if %>
            <tr>
              <td class="tb" width=60><b>INICIO:</b></td>
              <td class="tb" ><%=exibir("data_inicio")%></td>
              <tr height=2><td></td></tr>
            </tr>
            <tr>
              <td class="tb" width=60 ><b>VENCIMENTO:</b></td>
              <td class="tb" ><%=exibir("data_vencimento")%></td>
              <tr height=2><td></td></tr>
            </tr>
            <tr>
              <td class="tb" width=60 ><b>REAJUSTE:</b></td>
            ...
            <tr>
              <td class="tb" width=60><b>SERVIÇO:</b></td>
          ...
          <table width=400 border=0 cellspacing="0" cellpadding="0">
            <tr>
              <td class="tb" width=165 ><b>TAXA DE ADMINISTRAÇÃO:</b></td>
              <td class="tb"><%=exibir("taxa")%>%</td>
              <tr height=5><td></td></tr>                            
            </tr>
            <tr>
              <td class="tb" width=165><b>MULTA POR ATRAZO:</b></td>
              <td class="tb"><%=exibir("multa")%>%</td>
              <tr height=5><td></td></tr>
            </tr>
            <tr>
              <td class="tb" width=165><b>INDICE DE REAJUSTE:</b></td>
              <td class="tb">
            ...
            <tr>
              <td class="tb" width=165><b>COMISSÃO DO CORRETOR:</b></td>
              <td class="tb"><%=exibir("comissao")%>%</td>
              <tr height=5><td></td></tr>
            </tr>
            <tr colspan=2>
          </table>
