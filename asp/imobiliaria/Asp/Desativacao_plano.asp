      ...
      <!--#INCLUDE FILE ="Main_Topo.asp"-->
          ...
          <table width=100% border=0 bgcolor=#E8E8E8 cellspacing="0" cellpadding="0">
            <tr> 
              ...
              <td class="tb">
                <B>DESATIVAÇÃO PLANO DE MIDIA</B>
              </td>
          ...
          <table width=100% border=0 cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="tb" width=130><b>DATA ATIVAÇÃO:</b></td>
              <td class="tb"><%=exibir("data_efetivacao")%></td>
            </tr>
            <tr>
              <td class="tb" width=130><b>VENCIMENTO:</b></td>
              <td class="tb"><%=exibir("data_inativacao")%></td>
            </tr>
            <tr>
              <td class="tb" width=130><b>DIA DE EXIBIÇÃO:</b></td>
