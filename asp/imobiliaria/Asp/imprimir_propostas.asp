...
if box <> "" then
   conn.Execute ("update propostas set status=1 where codigo IN ("&box&")")
end if
...
itens.Open "select * from propostas where status=0 "&sql&" ORDER BY "&ordem&" "&ordem2,conn%>
<html>
<head>
<title></title>
  ...
  <tr>
    <td class="navdroplist">
      ...
      <table width=100% align="center" bgcolor="#f7f7f7" border=0>
        <tr>
          <td class="navdroplist" align=center><B>RELATÓRIO PROPOSTAS</B></td>
        </tR>
      </table>
      <br>
      <table width=100% align="center" bgcolor="#FFFFFF" border=0>
        ...
        <tr>
          ...
          <td class="navdroplist">
          <%set contador = conn.execute("select count(codigo) as total from propostas where status=0 "&sql)%>
      ...
      <table width=100% align="center" bgcolor="#FFFFFF" border=0>
        ...
        <%else%>
         <tr>
           ...
           <td class="navdroplist"><b>DATA INCLUSÃO:</b></td>
         </tr>
