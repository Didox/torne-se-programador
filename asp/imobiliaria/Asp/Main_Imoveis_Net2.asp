...
'********Customização para verificar o endereço de acordo com o cep fornecido no passo anterior********
'Autor: Bolonha
'Data: 12/09/2005
'Primeiro verifico o endereço do cep fornecido no banco de dados enderecos.mdb, em seguida verifico se
'o bairro do cep fornecido está cadastrado no banco do sistema imobiliaria, caso não esteja o mesmo será 
'cadastrado e em seguida os dados do endereço do cep fornecido será exibido na tela.
...
<table border="0" width="777" cellspacing="0" cellpadding="0" height="100%">
  <tr>
    <td>
          ...
          <td colspan=2>
            <table cellspacing=0 cellpadding=0>
              <tr>
				...
				'***************Normalização***********************
				'Tabela de Estados não contem UF
				'**************************************************
        ...
        <tr>
          <td colspan=2>
            <img src="../img/obrigacao.gif">&nbsp;<span class="estilo">&nbsp;Endereço:          </td>
        </tr> 
        <tr>
        ...
        <tr>
          <td> 
            <img src="../img/obrigacao.gif">&nbsp;<span class="estilo">&nbsp;Número:          </td>
        </tr> 
        <tr>
          <td>
            <input type="text" name="numero" value="<%=numero%>" label="valor" style="width:70; height:17;" maxlength="50">(Não será informado no anúncio.)          </td>
        </tr> 
        <tr>
          <td>
        ...
        <tr>
          <td>
            <input type="text" name="Complemento" value="<%=Complemento%>" label="valor" style="width:100; height:17;" maxlength="50">(Não será informado no anúncio.)          </td>
        </tr>
        <tr>
          <td>
            <span class="estilo">&nbsp;Nome do Condomínio:          </td>
        </tr> 
        <tr>
          <td>
      ...
      <tr>
       <td>
        &nbsp;&nbsp;<span class="estilo">&nbsp;N° Domitórios:       </td>
       <td>
      ...
      <tr>
        <td colspan=2>
          <img src="../img/obrigacao.gif">&nbsp;<span class="estilo">&nbsp;Idade do Imóvel:        </td>
      </tr>
      <tr>
        <td colspan=2>
          <select name="idade" >
