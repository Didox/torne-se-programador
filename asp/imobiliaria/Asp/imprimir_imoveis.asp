...
itens.Open "select * from imoveis  where status<>1 "&sql&sql_filtro&" ORDER BY "&ordem&" "&ordem2,conn
%>
  ...
  <tr>
    <td class="navdroplist">
      <table width=100% align="center" bgcolor="#FFFFFF">
        <tr>
          <td class="navdroplist">
            <a href="<%=pagina%>.asp?codigo=<%=verificador("codigo")%>"><img src="../img/logopb.gif" border=0></a>
          </td>
        </tR>
      </table>
      <br>
