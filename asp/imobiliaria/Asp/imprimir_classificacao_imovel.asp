...
itens.Open "select * from classificacao_imovel where status=0 "&sql&" ORDER BY "&ordem&" "&ordem2,conn%>
<html>
<head>
<title></title>
  ...
  <tr>
    <td class="navdroplist">
      ...
      <table width=100% align="center" bgcolor="#f7f7f7" border=0>
        <tr>
          <td class="navdroplist" align=center><B>RELATÓRIO CLASSIFICAÇÃO DO IMÓVEL</B></td>
        </tR>
      </table>
      <br>
