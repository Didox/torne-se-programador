...
itens.Open "select * from tipo_moeda where status=0 "&sql&" order by descricao "&ordem&ordem2,conn%>
<html>
<head>
<title></title>
  ...
  <tr>
    <td class="navdroplist">
      ...
      <table width=100% align="center" bgcolor="#f7f7f7" border=0>
        <tr>
          <td class="navdroplist" align=center><B>RELATÓRIO TIPO MOEDA</B></td>
        </tR>
      </table>
      <br>
