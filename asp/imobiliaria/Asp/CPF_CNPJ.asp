...
Function substest(est)
  estd = UCase(est)
  estd = replace(replace(estd,"Ã","A"),"Á","A")
  estd = replace(replace(estd,"Ê","E"),"É","E")
  estd = replace(replace(estd,"Î","I"),"Í","I")
  estd = replace(replace(estd,"Õ","O"),"Ó","O")
  estd = replace(replace(estd,"Û","U"),"Ú","U")
