...
if box <> "" then
   conn.Execute ("update Situacao set status=1 where codigo IN ("&box&")")
end if
...
itens.Open "select * from Situacao where status=0 "&sql&" ORDER BY "&ordem&" "&ordem2,conn%>
<html>
<head>
<title>:::::Imobi....:::</title>
      ...
      <!--#INCLUDE FILE ="Main_Topo.asp"-->
          ...
          <table width=100% border=0 bgcolor=#E8E8E8 cellspacing="0" cellpadding="0">
            <tr> 
              ...
              <td class="tb"><B>PAINEL DE CONTROLE SITUAÇÃO</B></td>
            </tr>
          </table>  
          <table width=100%
            ...
            <tr>
              ...
              <td><a href="Imprimir_Situacao.asp?currentPage=<%=currentPage%>&ordem=<%=ordem%>&ordem2=<%=ordem2%>&pesquisa=<%=pesquisa%>&opcao=<%=opcao%>&pagina=Main_Situacao"><img src="../img/icone-imprimir.gif" alt="Imprimir Situações" border=0></a></td>
              <td><a href="Cad_Situacao.asp?pagina=Main_Situacao"><img alt="Nova Situação" src="../img/novo_reg.gif" border=0></a></td>
            </tr>
               ...
               do While Not itens.EOF and cont<itens.PageSize
                  ...
                  <tr>
                    ...
                    <td bgcolor=<%=cor%> align=center>
                      ...
                      <a href="Alt_Situacao.asp?codigo=<%=itens("codigo")%>&pagina=Main_Situacao"><img src="../img/editar.gif" alt="Editar" border=0></a>
                    </td>
                  </tr>
                  <%cont=cont+1%>
                  <%itens.movenext%>
