...
itens.Open "select * from tipo_conta where status=0 and tipo=1 "&sql&" ORDER BY "&ordem&" "&ordem2,conn%>
<html>
<head>
<title></title>
  ...
  <tr>
    <td class="navdroplist">
      ...
      <table width=100% align="center" bgcolor="#f7f7f7" border=0>
        <tr>
          <td class="navdroplist" align=center><B>RELATÓRIO TIPO(S) DE CONTA</B></td>
        </tR>
      </table>
      <br>
